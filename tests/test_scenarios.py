...
class TestGameScenarios:
    ...
    @pytest.mark.asyncio
    async def test_emergency_safety_mechanism(self):
        ...
        valid_actions = engine.get_valid_actions("safety1")
    ...
    @pytest.mark.asyncio
    async def test_veto_power_unlocked_at_c12(self):
    ...
    @pytest.mark.asyncio
    async def test_power_triggers_at_thresholds(self):
    ...
    @pytest.mark.asyncio
    async def test_role_distribution_correctness(self):
    ...
    @pytest.mark.asyncio
    async def test_deck_exhaustion_win_condition(self):
    ...
    @pytest.mark.asyncio
    async def test_multiple_win_conditions_priority(self):
    ...
    @pytest.mark.asyncio
    async def test_player_elimination_mechanics(self):
    ...
    @pytest.mark.asyncio
    async def test_information_filtering_works(self):
        ...
        safety_view = engine.get_game_state("safety1")
        agi_view = engine.get_game_state("agi")
        full_view = engine.get_game_state()  # Unfiltered
    ...
    @pytest.mark.asyncio
    async def test_three_failed_proposals_auto_publish(self):
    ...
    @pytest.mark.asyncio
    async def test_game_progresses_with_random_players(self):
        ...
        while not engine._current_state.is_game_over and turns < max_turns:
            ...
            for player in state.alive_players:
                actions = engine.get_valid_actions(player.id)
            ...
            if valid_actions:
                ...
                if not result.success:
                    # Fallback to observe
                    await engine.perform_action(acting_player, ActionType.OBSERVE)
...
class TestSpecificMechanics:
    ...
    @pytest.mark.asyncio
    async def test_director_rotation_works(self):
    ...
    @pytest.mark.asyncio
    async def test_paper_deck_structure(self):
    ...
    @pytest.mark.asyncio
    async def test_valid_actions_generation(self):
        ...
        director_actions = engine.get_valid_actions(director_id)
