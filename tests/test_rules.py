...
from secret_agi.engine.models import (
    GameState, Player, Paper, Role, Allegiance, Phase
)
...
class TestEngineerEligibility:
    ...
    def test_get_eligible_engineers(self):
        ...
        players = [
            Player("p1", Role.SAFETY, Allegiance.SAFETY, alive=True, was_last_engineer=False),
            Player("p2", Role.ACCELERATIONIST, Allegiance.ACCELERATION, alive=True, was_last_engineer=True),
            Player("p3", Role.AGI, Allegiance.ACCELERATION, alive=False, was_last_engineer=False),
            Player("p4", Role.SAFETY, Allegiance.SAFETY, alive=True, was_last_engineer=False),
        ]
    ...
    def test_reset_engineer_eligibility(self):
        ...
        players = [
            ...
            Player("p2", Role.ACCELERATIONIST, Allegiance.ACCELERATION, was_last_engineer=True),
        ]
