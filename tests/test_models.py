...
class TestGameEvent:
    ...
    def test_event_creation(self):
        ...
        event = GameEvent.create(
            EventType.ACTION_ATTEMPTED, "player1", {"action": "nominate"}, 5
        )
...
class TestUtilityFunctions:
    ...
    def test_create_standard_deck(self):
        ...
        capability_counts: dict[int, int] = {}
        safety_counts: dict[int, int] = {}
    ...
    def test_get_role_distribution(self):
        ...
        for count in range(5, 11):
            ...
            assert (
                distribution[Role.SAFETY]
                >= distribution[Role.ACCELERATIONIST] + distribution[Role.AGI]
            )

        # Test specific distributions
        assert get_role_distribution(5) == {
            Role.SAFETY: 3,
            Role.ACCELERATIONIST: 1,
            Role.AGI: 1,
        }
        assert get_role_distribution(10) == {
            Role.SAFETY: 6,
            Role.ACCELERATIONIST: 3,
            Role.AGI: 1,
        }
