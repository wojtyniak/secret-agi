...
class TestGameEngine:
    ...
    def test_get_valid_actions(self):
        ...
        non_director_ids = [p.id for p in engine._current_state.players if p.id != director_id]
    ...
    def test_perform_action(self):
        ...
        result = engine.perform_action(director_id, ActionType.NOMINATE, target_id=target_id)
        ...
        assert "already nominated" in result.error
    ...
    def test_no_active_game(self):
        ...
        assert result.success is False
        assert "No active game" in result.error
