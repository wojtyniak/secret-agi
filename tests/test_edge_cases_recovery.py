...
from secret_agi.engine.game_engine import GameEngine, recover_game, load_game, find_interrupted_games
...
class TestGameStateRecovery:
    ...
    async def test_checkpoint_creation_and_restoration(self):
        ...
        initial_capability = original_state.capability
        initial_safety = original_state.safety
